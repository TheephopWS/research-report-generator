...
from deepeval.metrics import ContextualRelevancyMetric, GEval, FaithfulnessMetric
...
relevancy_metric = FaithfulnessMetric(threshold=0.7, model=deepseek_model, verbose_mode=True)
